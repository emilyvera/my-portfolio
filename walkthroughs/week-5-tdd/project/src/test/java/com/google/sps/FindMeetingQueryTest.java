...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeNotConsidered() {
    // Have an optional attendee C who has an all day event. Only slots 1, 2, and 3 should return
    //
    // Events  :       |--A--|     |--B--|
    //         : |--------------C--------------|   
    // Day     : |-----------------------------|
  ...
  public void optionalAttendeeConsidered() {
    // Have an optional attendee C who has an event between A and B. Only times 1 and 3 will return.
    //
    // Events  :       |--A--|     |--B--|
    //         :             |--C--|   
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeResultsInSmallSlot() {
    // Have B be an optional attendee. They should be ignored and the middle time slot should return.
    //
    // Events  : |--A--|     |----A----|
    //         :       |-B-|
    // Day     : |---------------------|
